...
import CommuniqueView from 'src/sections/_cluster-portal/_communique/view/communique-view';

// ----------------------------------------------------------------------

export default async function CommuniquePage() {
  const CommuniqueData = await sanityFetch({ query: COMMUNIQUES_QUERY });
  return CommuniqueData && <CommuniqueView communiques={CommuniqueData} />;
}
